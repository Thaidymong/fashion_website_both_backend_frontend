...
?>
<?php
include("../crud/featureProduct.php");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto h-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link " href="bannerProduct.php">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
                        </div>
                ...
                <li class="nav-item ">
                    <a class="nav-link active" href="featureProduct.php">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
                        </div>
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Feature Page</li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Feature Page</h6>
                </nav>
                ...
                <div class="col-12">
                        ...
                        <div class="card-body ">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0" id="example">
                                    <thead>
                                        <tr>
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Exclusive Id</th>
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Exclusive Name</th>
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Exclusive Amount</th>
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Exclusive Cut</th>
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Exclusive Offer</th>
                                    ...
                                    <tbody>
                                        <?php
                                      $banner_sql     = "SELECT * FROM `tb_featureproducts`";
                                      ...
                                      ?>
                                                ...
                                                <td class="align-middle text-center">
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <span class="text-secondary text-xs font-weight-bold"><?= $row['pro_amount'] ?></span>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <span class="text-secondary text-xs font-weight-bold"><?= $row['pro_cut'] ?></span>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <span class="text-secondary text-xs font-weight-bold"><?= $row['pro_offer'] ?></span>
                                                    </td>
                                                     <td class="align-middle text-center">
                                                        <img style="width: 60px;height: 60px; object-fit:contain;" src="../featureProduct_image/<?= $row['image'] ?>" alt="">
                                                    </td>
                                                ...
                                                <div class="modal-content text-white" >
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">Exclusive Name</label>
                                                                <input type="text" name="txt_name" class="form-control" value="<?= $row['name'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">Exclusive Amount</label>
                                                                <input type="text" name="txt_amount" class="form-control" value="<?= $row['pro_amount'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">Exclusive Cut</label>
                                                                <input type="text" name="txt_cut" class="form-control" value="<?= $row['pro_cut'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">Exclusive Offer</label>
                                                                <input type="text" name="txt_offer" class="form-control" value="<?= $row['pro_offer'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">Exclusive Image</label>
                                                                <input type="file" name="txt_image" class="form-control">
                                                            </div>

                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                                                                <button type="submit" name="btn-update-featureProduct" class="btn btn-success">Update</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                        ...
                                        <div class="modal fade" id="deleteModel<?= $row['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content text-dark" >
                                                    <div class="modal-header">
                                                        <h5 class="modal-title " id="exampleModalLongTitle">Delete Feature Product</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form action="" method="post" enctype="multipart/form-data">
                                                            <p>Are you sure to delete this feature product?</p>
                                                            <div class="form-group">
                                                                <input type="hidden" name="txt_id" class="form-control" value="<?= $row['id'] ?>">
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                                <button type="submit" name="btn-delete-featureProduct" class="btn btn-danger">Delete</button>
                                                            </div>
                                                        </form>
                                                    </div>
                    ...
                    <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content text-white" >
                                <div class="modal-header">
                                    <h5 class="modal-title " id="exampleModalLongTitle">Product Feature</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="">Product Cut</label>
                                            <input type="text" name="txt_cut" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Product Offer</label>
                                            <input type="text" name="txt_offer" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                                            <button type="submit" name="btn-submit-featureProduct" class="btn btn-success">Insert</button>
                                        </div>
                                    </form>
                                </div>
