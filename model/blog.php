            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Blog Page</li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Blog Page</h6>
                </nav>
                        ...
                        <div class="card-body ">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0" id="example">
                                    ...
                                    <tbody>
                                        <?php
                                        $banner_sql     = "SELECT * FROM `tb_blogggg`";
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <span class="text-secondary text-xs font-weight-bold"><?= $row['subtitle'] ?></span>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <span class="text-secondary text-xs font-weight-bold"><?= $row['date'] ?></span>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <span class="text-secondary text-xs font-weight-bold"><?= $row['admin'] ?></span>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <img style="width: 60px;height: 60px; object-fit:contain;" src="../blog_image/<?= $row['image'] ?>" alt="">
                                                    </td>
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="" method="post" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="txt_subtitle" class="form-control" value="<?= $row['subtitle'] ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="txt_admin" class="form-control" value="<?= $row['admin'] ?>">
                                                                    </div>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="submit" name="btn-update-blog" class="btn btn-success">Update</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                ...
                                                <div class="modal fade" id="deleteModel<?= $row['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content text-dark" >
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="" method="post" enctype="multipart/form-data">
                                                                    <p>Are you sure to delete this blog info?</p>
                                                                    <div class="form-group">
                                                                        <input type="hidden" name="txt_id" class="form-control" value="<?= $row['id'] ?>">
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                                        <button type="submit" name="btn-delete-blog" class="btn btn-danger">Delete</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                    ...
                    <div class="text-end">
                        ...
                        <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content text-white" >
                                    <div class="modal-header">
                                        <h5 class="modal-title " id="exampleModalLongTitle">Insert Blog Page</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="">Sub Title</label>
                                                <input type="text" name="txt_subtitle" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="">Date</label>
                                            ...
                                            <div class="form-group">
                                                <label for="">Admin</label>
                                                <input type="text" name="txt_admin" class="form-control">
                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                                                <button type="submit" name="btn-submit-blog" class="btn btn-success">Insert</button>
                                            </div>
                                        </form>
                                    </div>
