                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="text-secondary text-xs font-weight-bold"><?= $row['password'] ?></span>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="badge badge-sm bg-gradient-secondary"><?= $row['address'] ?></span>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
...
if (isset($_POST['btn-delete-user'])) {
    ...
    if ($result == TRUE) {
        echo "<script> location.href='list_register.php'; </script>";
    }
}
